...
export interface LegacyTextAreaAutosizeProps
...
export interface LegacyTextAreaAutosizeState {
  /**
...
export interface LegacyTextAreaAutosizeNodeStyling {
  /**
 ...
 */
export declare class LegacyTextAreaAutosize extends React.PureComponent<
  LegacyTextAreaAutosizeProps,
  LegacyTextAreaAutosizeState
> {
  /**
   ...
   */
  public calculateNodeStyling: (node: HTMLTextAreaElement) => LegacyTextAreaAutosizeNodeStyling;
