 ...
 * ```
 */
export type TooltipLayer = React.FC<React.PropsWithChildren<TooltipLayerProps>>;
...
export interface TooltipProps
  extends Omit<TooltipLayerProps, "onNonAccessibleClick" | "animationStyle"> {
  /**
...
export declare class TooltipComponent extends React.Component<TooltipProps, TooltipState> {
   ...
   */
  public shouldShowTooltip: (props: TooltipProps, state: TooltipState) => boolean;
 ...
 * @example
 * ```tsx
 * <TooltipContainer text="Click to save" element="button" className="save-btn">
 *   Save Changes
 * </TooltipContainer>
 * ```
 */
export type TooltipContainer = React.FC<React.PropsWithChildren<TooltipContainerProps>>;
