...
export declare class EmptyStateImageComponent extends React.PureComponent<EmptyStateImageProps> {}

/**
 * An image for the empty state.
 */
export type EmptyStateImage = typeof EmptyStateImageComponent;
