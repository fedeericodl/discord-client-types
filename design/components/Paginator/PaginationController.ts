...
export declare class PaginationControllerComponent extends React.PureComponent<PaginationControllerProps> {
  /**
 ...
 * ```
 */
export type PaginationController = typeof PaginationControllerComponent;
